...
window.renderRecords = function(year, mode) {
  ...
  {id:'racha_goles', title:'Racha Goleadora', description:'Partidos consecutivos con al menos 1 gol', list: rachasListGoles},
    ...
    {id:'ganados_temporada', title:'Partidos Ganados en Temporada', description:'Cantidad de partidos ganados por jugador en una temporada', list: seasonWinsList},
  ...
  recordsToRender = records.filter(r => ['max_goles_temporada','puntos_temporada','ganados_temporada'].includes(r.id));
  } else if (mode === 'rachas') {
  ...
  const historicosOrder = ['partidos_jugados', 'victorias_totales', 'goles_total', 'max_goles_partido', 'autogoles'];
