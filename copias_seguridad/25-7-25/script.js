...
function renderDashboardJugador(metricasPorJugador) {
  ...
  function mostrarDashboard() {
    ...
    const golesNiveles = [
      { min: 1,   icon: '⚽', nombre: 'Madera',           colorClass: 'nivel-1' },
    ...
    if (golesHistoricos < 1) {
      medallas.push({
        icon: '🔒',
        tooltip: 'Logro bloqueado<br>Marca al menos 1 gol para desbloquear',
        locked: true,
        colorClass: '',
    ...
    if (partidosHistoricos < 1) {
      medallas.push({
        icon: '🔒',
        tooltip: 'Logro bloqueado<br>Juega al menos 1 partido para desbloquear',
        locked: true,
        colorClass: '',
        cartelProgreso: '<span class="medalla-progreso-cartel locked">Logro bloqueado</span>'
      });
    ...
    if (victoriasHistoricas < 1) {
      medallas.push({
        icon: '🔒',
        tooltip: 'Logro bloqueado<br>Gana al menos 1 partido para desbloquear',
        locked: true,
        colorClass: '',
        cartelProgreso: '<span class="medalla-progreso-cartel locked">Logro bloqueado</span>'
      });
